    ...
    return $table
        ...
        ->actions([
            ActionGroup::make([
                ...
                // Opción 2: Abrir Orden de Trabajo
        ...
        //************************************************************************************************************* */
                                    ...
                                    // Opción 3: Variable de Prueba
                    Action::make('variablePrueba')
                    ->label('Variable de Prueba')
                    ->icon('heroicon-o-cog') // Mismo icono de "Configuración" para referencia
                    ->color('warning') // Mismo color que la opción anterior
                    ->tooltip('Esto es solo una prueba de variable')
                    ->modalHeading('Órdenes Abiertas para el Equipo')
                    ->modalWidth('lg')
                    ->modalContent(function (Action $action) {
                        // Simular datos de órdenes abiertas
                        $ordenesAbiertas = collect([
                            (object) ['id' => 1, 'solicitante' => 'Usuario A', 'fechaNecesidad' => '2024-12-20', 'prioridad' => 'alta'],
                            (object) ['id' => 2, 'solicitante' => 'Usuario B', 'fechaNecesidad' => '2024-12-21', 'prioridad' => 'media'],
                        ]);
                        
                        $equipo = (object) ['codEquipo' => 'EQUIPO-12345']; // Simular equipo asociado

                        // Renderizar la vista con datos simulados
                        return view('filament.equipos.cerrar-orden-modal', [
